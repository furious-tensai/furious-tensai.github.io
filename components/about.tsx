  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        . I am also familiar with TypeScript and TailwindCSS, MaterialUI. I am
      ...
      <p>
        ...
        video games, watching movies and play basketball. I also enjoy{" "}
        <span className="font-medium">learning new things</span> and not afraid
        of failure.
      </p>
    </motion.section>
  );
